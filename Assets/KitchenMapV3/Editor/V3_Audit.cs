...
public static class V3Audit
{
    ...
    static void T0Report(StringBuilder sb)
    {
        ...
        sb.AppendLine("  ㉡ V1 5분 예산: ▶ 스톱워치 — 매트→러그 존→아일랜드行 경사로·쉼터→아일랜드→카트→상판 (초과 시 놀이터 삭감 순서표)");
        ...
        sb.AppendLine("  경사로와 평평한 쉼터 (조리대 출구 x39.2~44.8 · 아일랜드 x38~50) | 싱크 바닥 7.4 스텝 8.3/9.3+턱2");
